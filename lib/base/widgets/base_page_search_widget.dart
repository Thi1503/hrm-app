        ...
        () => SliverAppBar(
          ...
          flexibleSpace: LayoutBuilder(
            ...
            return FlexibleSpaceBar(
              ...
              title: UtilWidgets.buildAppBarTitle(titleAppBar),
            );
          }),
        ),
      ),
              ...
              Container(
                ...
                child: BuildInputText(
                  InputTextModel(
                    ...
                    hintTextColor: AppColors.textFieldHintTextColor,
                    hintTextSize: AppDimens.fontSmall(),
                    iconAssets: Assets.ASSETS_ICONS_ICON_SEARCH_SVG,
                    fillColor: AppColors.backgroundSearch,
                    // colorIconPrefix: AppColors.gray4,

                    // enabledBorder: BorderSide(
                    //   color: AppColors.grayBorder, // Màu của đường viền// Độ dày của đường viền
                    // ),
                  ),
                ),
              ).paddingOnly(
